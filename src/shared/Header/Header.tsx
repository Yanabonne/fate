  ...
  return (
    <header className="header">
      <div className="header__header">
        <a className="header__link" onClick={() => navigate("/fate")}>
        ...
        <div
          className={
            isBurgerPopupOpen
              ? "header__nav-container header__nav-container_active"
            ...
            {/* <a
              className={
                activeLink === "about"
                  ...
                  : "header__link hover-underline-animation"
              }
        ...
        <GiHamburgerMenu
          ...
          onClick={() => setIsBurgerPopupOpen(true)}
        />
      </div>
    </header>
  );
